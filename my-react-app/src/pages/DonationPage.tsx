  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-gray-100 rounded-lg shadow-lg">
      ...
      <p className="text-gray-800 mb-6 text-center text-lg">
        Your donation helps us bring innovation to agriculture. Scan the QR code
        below to contribute and support our initiatives!
      </p>
      ...
      <div className="bg-white p-8 rounded-lg shadow-md mb-10">
        ...
        <ol className="list-decimal pl-6 text-lg">
          ...
          <li className="text-gray-800 mb-2">
            <strong>Aui</strong> - <span className="text-green-600">$50</span>
          </li>
          <li className="text-gray-800 mb-2">
            <strong>Luga</strong> - <span className="text-green-600">$25</span>
          </li>
          <li className="text-gray-800">
            <strong>Tang</strong> - <span className="text-green-600">$10</span>
          </li>
        </ol>
      </div>
